...
const TAGLINES: Record<string, string> = {
  ...
  'getimg-ai': 'リアル系の生成から編集までオールインワン',
  kling: 'コスパ最強のAI動画生成',
            ...
            <div key={tool.id} style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 6 }}>
                ...
                <span style={{
                  ...
                  background: meta.color + '14', padding: '2px 8px', borderRadius: 4,
                }}>{meta.label}</span>
                <span style={{ fontSize: 16, fontWeight: 700, color: 'var(--color-text)' }}>{tool.name}</span>
              </div>
              <p style={{ fontSize: 13, color: 'var(--color-text-muted)', margin: '0 0 10px', paddingLeft: 38 }}>{tagline}</p>
